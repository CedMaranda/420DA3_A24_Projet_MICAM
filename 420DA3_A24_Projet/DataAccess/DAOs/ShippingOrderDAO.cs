        ...
        try {
            return this.context.ShippingOrders
                ...
                .Where(so =>
                        ...
                        || so.SourceClient.ClientName.ToLower().Contains(criterion.ToLower())
                        ...
                        || so.ShippingOrderProducts.Any(sop => sop.Product.ProductName.ToLower().Contains(criterion.ToLower()))
