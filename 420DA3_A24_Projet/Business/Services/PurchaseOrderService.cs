...
internal class PurchaseOrderService {
    ...
    /// <param name="includeDeleted"></param>
    /// <returns></returns>
    public List<PurchaseOrder> GetIncompletePOsForWarehouse(Warehouse loggedInEmployeeWarehouse, bool includeDeleted = false) {
    ...
    public PurchaseOrder UpdatePO(PurchaseOrder po) {
        if (po.Status == PurchaseOrderStatusEnum.Completed) {
            ...
            po.OrderedProduct.ProductQuantity += po.Quantity;
